...
exports.DATABASE_URL = process.env.DATABASE_URL || 'postgres://postgres:root@localhost:5432/koa-skeleton';
...
exports.RECAPTCHA_SITEKEY = process.env.RECAPTCHA_SITEKEY || '6LfFEvsSAAAAAOhOS5g24zMzKzR9ox3T-wmZf0rK';
exports.RECAPTCHA_SITESECRET = process.env.RECAPTCHA_SITESECRET || '6LfFEvsSAAAAAGHycAS-eoMgx2EirKKjU_uDffg0';
